...
Checks and renders refresh existing FAQ card artwork from the current project background and style settings without rerunning transcription or semantic analysis.
